        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><i class="fa fa-life-ring"></i> Inicio</a>
                        ...
                        <ul class="nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="factura"><i class="fa fa-file-text-o" aria-hidden="true"></i> Factura </a>
                                        </li>
                                        <li>
                                            <a href="liquidacion">Liquidacion Compra</a>
                                        </li>
                                        <li>
                                            <a href="notacredito">Nota Cr&eacute;dito</a>
                                        </li>
                                        <li>
                                            <a href="notadebito">Nota D&eacute;bito</a>
                                        </li>
                                        <li>
                                            <a href="retencion">Retenci&oacute;n</a>
                                        </li>
                                        <li>
                                            <a href="guia">Guias</a>
                                        </li>
                                        <li>
                                            <a href="proforma">Proformas</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="compra"><i class="fa fa-shopping-cart fa-fw"></i> Compras</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="reporte">Comprobantes</a>
                                        </li>
                                        <li>
                                            <a href="reporte_ventas">Ventas</a>
                                        </li>
                                        <li>
                                            <a href="reporte_ventas_detallada">Ventas Detallada</a>
                                        </li>
                                            <li>
                                                <a href="total-retenciones">Retenciones Total</a>
                                            </li>
                                            <li>
                                                <a href="retenciones_factura">Retenciones Por Factura</a>
                                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    {% if is_granted('ROLE_EMISOR_ADMIN') %}
                                        <li>
                                            <a href="emisor">Emisor</a>
                                            <a href="borrar_doc">Borrar Doc. Prueba</a>
                                        </li>
                                    {% endif %}
                                    {% if is_granted('ROLE_ADMIN') or is_granted('ROLE_EMISOR_ADMIN') %}
                                        ...
                                        <li>
                                            <a href="ptoemision">Puntos de Emision</a>
                                        </li>
                                    {% endif %}
                                    ...
                                    {% if is_granted('ROLE_ADMIN') %}
                                        <li>
                                            ...
                                            <ul class="nav nav-third-level">
                                                <li>
                                                    <a href="impuesto_iva">IVA</a>
                                                </li>
                                                <li>
                                                    <a href="impuesto_ice">ICE</a>
                                                </li>
                                                <li>
                                                    <a href="impuesto_irbpnr">IRBPNR</a>
                                                </li>
                                            </ul>
                                            <!-- /.nav-third-level -->
                                        </li>
                                    ...
                                    {% if is_granted('ROLE_EMISOR_ADMIN') %}
                                        <li>
                                            <a href="facturas_load">Cargar Facturas</a>
                                        </li>
                                        <li>
                                            <a href="producto">Productos</a>
                                        </li>
                                        <li>
                                            <a href="producto_load">Cargar Productos</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="cliente_load">Cargar Cliente</a>
                                        </li>
                                    {% endif %}
                                    {% if is_granted('ROLE_ADMIN')%}
                                        <li>
